<template>
  <div class="container">
    <p class="title">点击选择投资区间 <span>（可多选）</span></p>
    <div class="flex-box">
      <div class="box active">
        <div class="item">
          <p class="per">5.4%-5.5%</p>
          <p class="day">30-90天</p>
        </div>
      </div>
      <div class="box">
        <div class="item">
    ...
    <p class="link"><a href="">《自动投资协议》</a></p>
    <a href="" class="btn">同意协议且开启自动投资</a>
    <div class="modal">
      <div class="box">
...
<style lang="less" scoped>
  ...
  * {
  ...
  .flex-box {
    ...
    .box.active {
      .item {
        background-image: url(../../../images/puyitou/selected-box.png);
