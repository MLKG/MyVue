<template>
  <div>
          ...
          <div class="common-user-item__info">
            <div class="common-user-item__info-right">
              ...
              <div v-else>
                ...
                <div>磐&nbsp;&nbsp;&nbsp;石：{{ user.investPs | currency }}</div>
              </div>
            </div>
          </div>
        </div>
    ...
    <div v-show="noMoreUser" class="load-more font-size-large font-color-gray">
      <span>没有更多用户了</span>
    </div>
    <div v-show="noUser" class="load-more font-size-large font-color-gray">
      <span>没有相关用户</span>
    </div>
  </div>
</template>
